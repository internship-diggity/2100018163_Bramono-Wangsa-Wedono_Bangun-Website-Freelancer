                                    ...
                                    <tr class="text-gray-700 border-b">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($order->user_buyer->detail_user->photo != NULL)
                                                        ...
                                                        loading="lazy" />
                                                    @else
                                                        <svg class="object-cover w-full h-full rounded-full text-gray-300" fill="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            @if ($order->order_status_id == '1')
                                                ...
                                                Details</a>
                                                <p class="px-4 py-2 mt-1 inline text-left text-green-500">Accept</p>
                                            ...
                                            @elseif ($order->order_status_id == '3')
                                                <a href="{{route('member.order.show', $order->id)}}"
                                                    class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                                    Details</a>
                                                <p class="px-4 py-2 mt-1 inline text-left text-red-500">Rejected</p>
                                            @elseif ($order->order_status_id == '4')
                                                ...
                                                <a href="{{route('member.reject.order', $order->id)}}"
                                                    class="px-4 py-2 mt-1 mr-2 text-center bg-white rounded-xl ">
                                                    Reject</a>
                                            @else
                                                {{'N/A'}}
                                            @endif
