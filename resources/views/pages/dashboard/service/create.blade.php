                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Service apa yang ingin kamu tawarkan?" type="text"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{old('title')}}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{old('description')}}" required>
