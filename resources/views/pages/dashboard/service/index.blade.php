                                            ...
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        ...
                                                        @else
                                                            <svg class=" object-cover w-full h-full rounded text-gray-300" fill="currentColor" viewboc="0 0 24 24">
                                                            <path d="M24 20.9923v24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zH16.002 9.999a4 4 0 11-8 0 4 4 0 018 0z"/>
                                                            </svg>
                                                        @endif
