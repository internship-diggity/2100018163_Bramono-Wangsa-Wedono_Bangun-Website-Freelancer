                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="advantage-services"
                                                class="block mb-2 font-medium text-gray-700 text-md">
                                                Keunggulan Service
                                            </label>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Total Harga Service Kamu" type="number" name="price"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{$service->price}}">
                                        </div>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan Kamu" type="text" name="advantage_service[]" id="advantage_service" autocomplete="advantage_service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
